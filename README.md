# DevOps | SRE | Cloud Platform Engineering | Kubernetes | AWS | Azure  ☁️
...
### 🛠️ **Tech Stack & Tools**
  ...
  -   Programming Language: Full-stack Java ,Spring Framework , Spring boot, Python 
  ...
  -   API Management and IAM: WSO2 Identity Server , Azure AD (Active Directory) , Azure API Management 
  -   Other Devops Tools: External-dns, Nginx Ingress-controller , Helm ,Tomee server , Azure KeyVault, Reloader
  -   AI/LLMOps: Ollama, vLLM, HuggingFace TGI, AWS Bedrock, FastAPI, NVIDIA GPU Operator , MCP Protocol
